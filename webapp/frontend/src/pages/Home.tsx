...
const Home: FC<HomeProps> = ({ onLaunch }) => (
        ...
        <header className="relative bg-black/60 backdrop-blur-lg border-b border-red-700/40 shadow-2xl">
            <div className="container mx-auto px-6 py-6 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex items-center space-x-4">
                    <div className="h-14 w-14 rounded-xl shadow-2xl bg-gradient-to-br from-red-700 via-red-600 to-red-800 border border-red-500/70 flex items-center justify-center text-white font-extrabold text-2xl">
                        IF
                    </div>
                    <div>
